...
public class FrictionlessEffect extends MobEffect {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        ...
        if (!entity.isCrouching()) {
            ...
            // AttributeModifier SPEED_MODIFIER_BEAN = new
            // AttributeModifier(UUID.fromString("4C179DD1-A49E-45DC-94CA-A3ED1C3F0B57"),
            // "Frictionless Boosty Boi", 1.099F, AttributeModifier.Operation.ADDITION);
            // assert speed != null;
